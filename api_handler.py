...
def agent_analyze_template(
    ...
    package = {
        ...
        "template": template_content, # Use the input template
    ...
    logger.info("Agent 'analyze_template' completed successfully.")
    return package
...
def agent_reverse_engineer_from_image(
    ...
    try:
        response = model.generate_content([meta_prompt_template, image_data])
    except Exception as e:
    ...
    package = {
        ...
        "use_case": parsed_json.get("use_case", "General"),
        "template": parsed_json.get("template", ""),
        "variables": list(set(re.findall(r'\[(.*?)\]', parsed_json.get("template", "")))),
        "variable_explanations": parsed_json.get("variables_explanation", {}),
        "examples": parsed_json.get("example_prompts", []),
        "tips": parsed_json.get("technical_tips", []),
        "description": parsed_json.get("description", ""),
    ...
    logger.info("Agent 'reverse_engineer_from_image' completed successfully.")
    return package
