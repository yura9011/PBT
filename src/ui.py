...
def render_idea_lab(prompts_config: Dict[str, Any]):
    ...
    with mode_tab3:
        ...
        user_context_image = st.text_area("Additional Context/Instructions (Optional)", placeholder="e.g., focus on the lighting style, ignore the text, capture the watercolor texture...", key="image_user_context")
            ...
            if not uploaded_image:
                ...
                try:
                    ...
                    user_inputs = {
                        ...
                        "user_context": user_context_image
                    }
                    st.session_state.workflow_running = True
                    st.session_state.prompt_package = None
                    st.session_state.user_inputs = user_inputs
